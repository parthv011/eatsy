    ...
    <div class="row justify-content-center">
        <div class="col-lg-10"> <div class="d-flex flex-column flex-md-row product-card-3d">
                <div class="col-md-5 p-3 product-image-container">
                    <img src="images/mpizza1.jpg" class="img-fluid product-image" alt="Margherita Pizza">
                </div>
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-10"> <div class="d-flex flex-column flex-md-row product-card-3d">
                <div class="col-md-5 p-3 product-image-container">
                    <img src="images/mpizza2.jpg" class="img-fluid product-image" alt="Margherita Pizza">
                </div>
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
                    <h1 class="display-4 fw-bold">Paneer Capsicum</h1>
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-10"> <div class="d-flex flex-column flex-md-row product-card-3d">
                <div class="col-md-5 p-3 product-image-container">
                    <img src="images/mpizza3.jpg" class="img-fluid product-image" alt="Margherita Pizza">
                </div>
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-10"> <div class="d-flex flex-column flex-md-row product-card-3d">
                <div class="col-md-5 p-3 product-image-container">
                    <img src="images/mpizza4.png" class="img-fluid product-image" alt="Margherita Pizza">
                </div>
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-10"> <div class="d-flex flex-column flex-md-row product-card-3d">
                <div class="col-md-5 p-3 product-image-container">
                    <img src="images/mpizza5.jpg" class="img-fluid product-image" alt="Margherita Pizza">
                </div>
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-10"> <div class="d-flex flex-column flex-md-row product-card-3d">
                <div class="col-md-5 p-3 product-image-container">
                    <img src="images/mpizza6.jpg" class="img-fluid product-image" alt="Margherita Pizza">
                </div>
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
