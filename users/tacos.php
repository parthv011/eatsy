...
<div class="container my-5">
    <h1 class="text-center mb-5">Our Delicious Tacos</h1>
            ...
            <div class="d-flex flex-column flex-md-row product-card-3d">
                ...
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
                    ...
                    <div class="d-grid gap-2 d-md-block">
                        <a href="../backend/add_to_cart.php?item=taco_paneer" class="cart-btn">
        ...
        <div class="col-lg-10">
            <div class="d-flex flex-column flex-md-row product-card-3d">
                ...
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
                    ...
                    <p class="lead">A delicious mix of seasonal vegetables, spiced and wrapped in a soft taco shell.</p>
                    <h2 class="mb-4 price-tag">₹ 240.00</h2>
                    <div class="d-grid gap-2 d-md-block">
                        <a href="../backend/add_to_cart.php?item=taco_vegetable" class="cart-btn">
                            <i class="fas fa-shopping-cart me-2"></i>Add To Cart
                        </a>
                    </div>
                </div>
        ...
        <div class="col-lg-10">
            <div class="d-flex flex-column flex-md-row product-card-3d">
                ...
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
                    ...
                    <p class="lead">A delicious taco filled with spiced black beans, topped with fresh vegetables and a zesty sauce.</p>
                    <h2 class="mb-4 price-tag">₹ 220.00</h2>
                    <div class="d-grid gap-2 d-md-block">
                        <a href="../backend/add_to_cart.php?item=taco_black_bean" class="cart-btn">
                            <i class="fas fa-shopping-cart me-2"></i>Add To Cart
                        </a>
                    </div>
                </div>
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-10">
            <div class="d-flex flex-column flex-md-row product-card-3d">
                <div class="col-md-5 p-3 product-image-container">
                    <img src="../includes/images/mt4.jpg" class="img-fluid product-image" alt="Butter Tacos">
                </div>
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
                    ...
                    <h2 class="mb-4 price-tag">₹ 360.00</h2>
                    <div class="d-grid gap-2 d-md-block">
                        <a href="../backend/add_to_cart.php?item=taco_butter" class="cart-btn">
                            <i class="fas fa-shopping-cart me-2"></i>Add To Cart
                        </a>
                    </div>
                </div>
