        ...
        <div class="col-lg-10">
            <div class="d-flex flex-column flex-md-row product-card-3d">
                ...
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
                    ...
                    <p class="lead">A classic pizza topped with fresh tomatoes, mozzarella cheese, and basil.</p>
                    <h2 class="mb-4 price-tag">₹ 150.00</h2>
                    <div class="d-grid gap-2 d-md-block">
                        <a href="../backend/add_to_cart.php?item=pizza_margherita" class="cart-btn">
        ...
        <div class="col-lg-10">
            <div class="d-flex flex-column flex-md-row product-card-3d">
                ...
                <div class="col-md-7 p-3 d-flex flex-column justify-content-center">
                    ...
                    <p class="lead">A pizza topped with paneer (Indian cottage cheese), capsicum (bell peppers), and a blend of spices.</p>
                    <h2 class="mb-4 price-tag">₹ 200.00</h2>
                    <div class="d-grid gap-2 d-md-block">
                        <a href="../backend/add_to_cart.php?item=pizza_paneer_capsicum" class="cart-btn">
                            <i class="fas fa-shopping-cart me-2"></i>Add To Cart
                        </a>
                    </div>
                </div>
